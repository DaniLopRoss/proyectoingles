...
class DocumentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documento" do
    assert_difference("Documento.count") do
      post documentos_url, params: { documento: { asunto: @documento.asunto, fecha: @documento.fecha, nombre: @documento.nombre, numerocontrol: @documento.numerocontrol, oficio: @documento.oficio, planestudos: @documento.planestudos, seccion: @documento.seccion } }
    end
  ...
  test "should update documento" do
    patch documento_url(@documento), params: { documento: { asunto: @documento.asunto, fecha: @documento.fecha, nombre: @documento.nombre, numerocontrol: @documento.numerocontrol, oficio: @documento.oficio, planestudos: @documento.planestudos, seccion: @documento.seccion } }
